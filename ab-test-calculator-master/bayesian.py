...
class Bayesian(object):
    ...
    generate_posterior_samples
        Membuat sampel untuk distribusi posterior untuk A dan B
    calculate_probabilities
        Hitung kemungkinan variannya lebih baik
    ...
    plot_simulation_of_difference
        Plot histogram yang menunjukkan distribusi perbedaan antara A dan B
        A dan B highlighting berapa banyak perbedaan yang menunjukkan perbedaan positif
        vs perbedaan negatif.
    ...
    def generate_posterior_samples(self):
        """Membuat sampel untuk distribusi posterior for A dan B"""
    ...
    def calculate_probabilities(self):
        """Hitung kemungkinan varians yang lebih baik"""
    ...
    def plot_simulation_of_difference(self):
        """
        Plot histogram menunjukkan distribusi perbedaan
        A dan B meng-highlight seberapa besar perbedaan yang menunjukkan perbedaan positif
        vs perbedaan negatif.
        """
